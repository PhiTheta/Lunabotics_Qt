...
# Assuming that source directory is at ../src relative to the build directory
PROTOPATH += ../src
PROTOPATHS =
...
protobuf_decl.commands = protoc --cpp_out=../src $${PROTOPATHS} ${QMAKE_FILE_NAME}
